...
import org.sample.naversmarteditor.vo.PhotoVo;
...
public class NaverSmartEditorController {
	...
	public ModelAndView post(HttpServletRequest request, @ModelAttribute("params") HttpHeaders params) {
		...
		ModelAndView model = new ModelAndView("NaverSmartEditPostResult");
		model.addObject("result", ((String[])parameterMap.get("smarteditor"))[0]);
